...
апострофы или переводы строки - использовать для данной строки кавычки
...
Если в файле используются двойные кавычки и в него вносятся лишь локальные
изменения - использовать в изменениях двойные кавычки.
