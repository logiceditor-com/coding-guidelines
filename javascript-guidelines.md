...
Скобки
------
Фигурные скобки ставятся на следующей строке и выравниваются по вертикали. Блок внутри фигурных скобок отбивается отступом.
```javascript
function foo()
{
  //Do something
...
//TODO Обязательность фигурных скобок
...
//TODO: if, while, catch -- нужен пробел перед скобками или нет
