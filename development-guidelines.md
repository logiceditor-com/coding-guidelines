...
`ag/mybranch/v2` (см. раздел _Ревью кода_). Git не позволяет в имени ветки
использовать больше двух слешей, поэтому для веток вида `ag/555/short_summary`
новая ветка будет `ag/555/short_summary_v2`.
