...
выделение двоеточия типа
конструктор объекта с предопределенными значениями
допускаемые короткие имена
...
Константы именуются ЗАГЛАВНЫМИ_БУКВАМИ.
    ...
    public static const THE_ULTIMATE_ANSWER : int = 42;

Обычные переменные, имена функций и проч. — camel case со срочной буквы.

    var someInputText : String;
